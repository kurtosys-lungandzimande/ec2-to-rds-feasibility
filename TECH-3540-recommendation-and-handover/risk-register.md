...
|---|---|---|---|---|
| AWS EC2 HA programme — 2022 vs GA feature unclear | Medium | High | Hermann is confirming with AWS account team whether Kurtosys is still on the 2022 programme or has moved to the GA feature (launched 2025-11-17). Do not assume either way. Public docs: https://docs.aws.amazon.com/sql-server-ec2/latest/userguide/sql-high-availability.html | Hermann |
